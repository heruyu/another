...
%Pliki te, określane zbiorczo jako zbiór danych, obejmują szeroki zakres typów treści,  z których każdy reprezentuje wiedzę możliwą do interpretacji przez człowieka. Od prac naukowych po osobiste notatki i pliki multimedialne, projekt systemu uwzględnia obsługę różnych formatów danych, aby zaspokoić indywidualne preferencje i wymagania użytkowników.\par
...
%Wraz z danymi będą przechowywanie metainformacje, opisujące te dane.  
\par
